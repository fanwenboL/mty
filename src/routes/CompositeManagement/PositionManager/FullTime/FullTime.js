        ...
        return (
            <div>
                <Card bodyStyle={{ padding: 5 }}>
                    <div style={{ float: 'right' }}><Input style={{ width: 200 }} /><Button style={{ marginLeft: 10 }} onClick={()=>{this.setState({persionDetailFlag:true})}} type="primary">新建全职简历</Button></div>
                </Card>
                    {/* 评估列表 */}
                    <Table
                        style={{ fontSize: 12 }}
                    ...
                    />
                    {
                        this.state.persionDetailFlag&&<FullTimeAddEdit/>
                    }
            </div >
        );
    }
