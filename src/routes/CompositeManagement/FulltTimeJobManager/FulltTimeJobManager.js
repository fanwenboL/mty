        ...
        return (
            <div style={{ padding: '0px 10px' }}>
                ...
                <Card bodyStyle={{ padding: 5 }}>
                    <div style={{ float: 'right' }}><Input style={{ width: 200 }} /><Button style={{ marginLeft: 10 }} type="primary">查询</Button><Button style={{ marginLeft: 10 }} onClick={this.openNewBanner.bind(this)} type="primary">新建全职职位</Button></div>
                </Card>
                <Card>
                    {/* 评估列表 */}
                    <Table
...
export default FulltTimeJobManager;
