        ...
        return (
            <div style={{ padding: '0px 10px' }}>
                ...
                <Card title={'企业用户列表'} style={{ marginTop: 20 }}>
                    <Row><div style={{ float: 'right' }}><Input style={{ width: 200 }} /><Button style={{ marginLeft: 10 }} type="primary">查询</Button>
                        <Button onClick={() => { this.setState({ enterpriseAddEditFlag: true }) }} style={{ marginLeft: 10 }} type="primary">新建企业</Button></div></Row>
                    {/* 评估列表 */}
                    <Table
                        style={{ fontSize: 12 }}
                        rowKey="id"
